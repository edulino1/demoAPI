...
insert into student (ra, name, email) values (1234,'Maria Eduarda', 'mduda@gmail.com');
insert into student (ra, name, email) values (1235,'Letícia Rodrigues', 'letrodr@uol.com.br');
insert into student (ra, name, email) values (1235,'Juan Oliveira', 'juanoliv@uol.com.br');
insert into student (ra, name, email) values (1235,'Isaac Newton', 'isnew@gmail.com');
